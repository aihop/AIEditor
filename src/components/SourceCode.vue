...
import { computed, ref, watch, nextTick, onBeforeUnmount, withDefaults, defineProps } from 'vue'
...
<template>
  <Dialog
    :open="store?.state.sourceCode"
    @update:open="open => (store.state.sourceCode = open)"
  >
    <DialogContent
