const locale: Record<string, string> = {
  ...
  'editor.emoji.title': 'Emoji',
  'editor.emoji.search': 'Search',
  'editor.emoji.search.placeholder': 'Search emojis...',
  'editor.emoji.categories.all': 'All',
  'editor.emoji.categories.smileys': 'Smileys & Emotion',
  'editor.emoji.categories.people': 'People & Body',
  'editor.emoji.categories.animals': 'Animals & Nature',
  'editor.emoji.categories.food': 'Food & Drink',
  'editor.emoji.categories.activities': 'Activities',
  'editor.emoji.categories.objects': 'Objects',
  'editor.emoji.categories.travel': 'Travel & Places',
  'editor.emoji.categories.symbols': 'Symbols',
  'editor.emoji.categories.flags': 'Flags & Math',
