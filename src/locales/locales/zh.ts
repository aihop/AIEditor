const locale: Record<string, string> = {
  ...
  'editor.specialCharacter.search.placeholder': '搜索表情...',
  ...
  'editor.emoji.tooltip': '表情符号',
  'editor.emoji.title': '表情符号',
  'editor.emoji.search': '搜索',
  'editor.emoji.search.placeholder': '搜索符号...',
  'editor.emoji.categories.all': '全部',
  'editor.emoji.categories.smileys': '笑脸与情感',
  'editor.emoji.categories.people': '身体与手势',
  'editor.emoji.categories.animals': '动物与自然',
  'editor.emoji.categories.food': '食物与饮料',
  'editor.emoji.categories.activities': '运动与活动',
  'editor.emoji.categories.objects': '物品',
  'editor.emoji.categories.travel': '旅行与天文',
  'editor.emoji.categories.symbols': '符号与标志',
  'editor.emoji.categories.flags': '旗帜与数学',
